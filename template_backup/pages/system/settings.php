                    ...
                    <div class="tab-content">
                        <div class="tab-pane <?php if ($section == "") echo 'active'; ?>" id="general">
							<form role="form" action="" method="post" id="generalSettingsForm">
								...
								<div class="form-group">
									...
									<p class="help-block"><?php _e('Full installation URL including http:// or https:// (eg. http://mydomain.com/eyenet/)'); ?></p>
								</div>
                        ...
                        <div class="tab-pane <?php if ($section == "templates") echo 'active'; ?>" id="templates">
							...
							<div class="text-center">
								...
								<a onClick='showM("?modal=notifications/edit&id=3&reroute=system/settings&section=templates");return false' data-toggle="modal" class="btn btn-flat btn-primary btn-sm"><?php _e('E Incident Unresolved'); ?></a>
							</div>
							<br>
