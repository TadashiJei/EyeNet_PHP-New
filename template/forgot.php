    ...
    <body class="auth-page">
        <div class="auth-card">
            ...
            <?php if(!isset($_GET['resetkey'])) { ?>
                <div class="auth-form">
                    <h5 class="text-center mb-4"><?php _e('Reset your password'); ?></h5>
                    <p class="text-muted text-center mb-4"><?php _e('Enter your email address and we\'ll send you instructions to reset your password.'); ?></p>
                    ...
                    <form action="?route=forgot" method="post">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-paper-plane me-2"></i><?php _e('Send Reset Link'); ?>
                            </button>
                        </div>
            ...
            <?php if(isset($_GET['resetkey'])) { ?>
                <div class="auth-form">
                    <h5 class="text-center mb-4"><?php _e('Create new password'); ?></h5>
                    <p class="text-muted text-center mb-4"><?php _e('Enter your new password below.'); ?></p>
                    ...
                    <form action="?route=forgot" method="post">
                        <div class="form-floating mb-4">
                            ...
                            <label for="passwordInput"><i class="fas fa-lock me-2"></i><?php _e('New Password'); ?></label>
                        </div>

                        <div class="d-grid">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="fas fa-check me-2"></i><?php _e('Set New Password'); ?>
                            </button>
                        </div>

                        <input type="hidden" name="resetPassword"/>
                        <input type="hidden" name="resetkey" value="<?php echo htmlspecialchars($_GET['resetkey']); ?>"/>
                    </form>
                </div>
            <?php } ?>
            ...
            <div class="auth-footer">
                <p class="mb-0">
                    <a href="?route=signin">
                        <i class="fas fa-arrow-left me-1"></i><?php _e('Back to Sign In'); ?>
                    </a>
                </p>
            </div>
        </div>
