<div class="modal-header">
    ...
    <h4 class="modal-title"><?php _e('Install EyeNet Server Agent'); ?></h4>
</div>

<div class="modal-body">

    <h4><?php _e('Follow the steps below to install the EyeNet Windows Agent on this server:'); ?></h4>

    <p><b>1.</b> <?php _e('Download agent installer from '); ?> <a href="./assets/EyeNet-agent-latest.exe"><?php _e('here'); ?></a> <?php _e('and install on your server.'); ?>.</p>

    <p><b>2.</b> <?php _e('Open EyeNet Agent after installation finishes.'); ?>.<br></p>
    ...
    <p><?php _e('Agent will begin reporting data to EyeNet in a few minutes.'); ?></p>
